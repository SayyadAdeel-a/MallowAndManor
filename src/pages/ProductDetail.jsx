    ...
    <div className="max-w-7xl mx-auto px-4 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14">
        ...
        <div>
          ...
          <p className="text-xs text-brand-wine-dark/50 mb-6">Shipping calculated at checkout.</p>

          {/* WhatsApp order */}
          {pp.showWhatsappOrder && (
            <button
              onClick={handleWhatsAppOrder}
              className="w-full flex items-center justify-center gap-2.5 bg-[#25D366] text-white py-3.5 rounded-full text-xs font-bold tracking-wider uppercase hover:bg-[#128C7E] transition-colors shadow-sm mb-6"
            >
          ...
          <button
            onClick={handleAdd}
            className="w-full bg-brand-burgundy text-brand-cream py-3.5 rounded-full text-xs font-bold tracking-wider uppercase hover:bg-brand-wine-dark transition-colors shadow-sm mb-10"
          >
            Add to Cart
          </button>
