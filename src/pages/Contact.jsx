...
export default function Contact() {
  ...
  const contactIcons = [
    { label: "Phone", value: "+92 323 3334492", iconKey: "phone", animation: "pulse" },
    { label: "Email", value: "hello@honeybeelane.com", iconKey: "mail", animation: "float" },
    { label: "Address", value: "DHA Phase 6, Karachi, Pakistan", iconKey: "location", animation: "bounce" },
  ];
